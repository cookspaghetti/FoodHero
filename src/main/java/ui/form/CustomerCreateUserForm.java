...
public class CustomerCreateUserForm extends JFrame {
    ...
    public CustomerCreateUserForm() {
        ...
        idField = new JTextField(IdGenerationUtils.getNextId(ServiceType.CUSTOMER, null, null));
